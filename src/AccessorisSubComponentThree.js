...
const AccessorisSubComponentThree = (props) => {
    ...
    <>
      <div class="bg-white flex">
        <div class="flex flex-col space-y-2">
          ...
          <div class="bg-gray-100 flex  border-l-4 border-yellow-500">
...
export default AccessorisSubComponentThree
